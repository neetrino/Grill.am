...
export default async function ContactPage({ params }: ContactPageProps) {
  ...
  return (
    <div className="-my-10 bg-white">
      <section>
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-stretch gap-8 px-4 pb-4 pt-10 sm:px-6 sm:pb-6 sm:pt-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-10 lg:pb-6 lg:pt-14">
