...
const CONFETTI = [
  { top: "12%", left: "18%", rotate: "18deg", tone: "bg-brand-red", size: "size-2.5" },
  { top: "18%", left: "78%", rotate: "-12deg", tone: "bg-brand-yellow", size: "size-2" },
  { top: "28%", left: "12%", rotate: "40deg", tone: "bg-brand-yellow", size: "size-3" },
  { top: "22%", left: "86%", rotate: "8deg", tone: "bg-brand-red", size: "size-2" },
  { top: "48%", left: "8%", rotate: "-24deg", tone: "bg-brand-red", size: "size-2.5" },
  { top: "52%", left: "90%", rotate: "32deg", tone: "bg-brand-yellow", size: "size-2.5" },
  { top: "68%", left: "16%", rotate: "12deg", tone: "bg-brand-yellow", size: "size-2" },
  { top: "72%", left: "84%", rotate: "-18deg", tone: "bg-brand-red", size: "size-3" },
] as const;
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      {CONFETTI.map((piece, index) => (
        <span
          ...
          className={`absolute ${piece.size} ${piece.tone} opacity-80 ${
            index % 2 === 0 ? "rounded-sm" : "rounded-[1px]"
          }`}
          style={{
            top: piece.top,
            left: piece.left,
...
export function CheckoutSuccessView({
  ...
  return (
    <section className="relative left-1/2 isolate w-screen max-w-[100vw] -translate-x-1/2 -my-10 overflow-hidden bg-[#faf6ee] pb-10 md:pb-10">
      <ConfettiLayer />

      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-12rem)] max-w-6xl flex-col items-center justify-center px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
