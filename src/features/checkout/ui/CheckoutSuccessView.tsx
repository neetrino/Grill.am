...
export function CheckoutSuccessView({
  ...
  return (
    <section className="storefront-bleed flex -mt-10 mb-[-2.5rem] min-h-[calc(100dvh/var(--desktop-layout-scale)-var(--storefront-header-offset))] items-center justify-center bg-white px-4 py-12 pb-28 sm:px-6 md:pb-12 lg:px-8">
