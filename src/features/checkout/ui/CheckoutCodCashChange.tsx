 ...
 * On mobile the block starts collapsed; expand via the header chevron.
 */
  ...
  return (
    ...
    >
      <button
        ...
        aria-controls="cod-cash-change-panel"
      ...
      >
        ...
        <ChevronDown
          className={`size-5 shrink-0 text-gray-500 transition-transform duration-200 lg:hidden ${
            expanded ? "rotate-180" : ""
          }`}
          aria-hidden
        />
