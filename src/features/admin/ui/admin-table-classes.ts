 ...
 */
/** Overrides shared `Card` defaults (rounded-lg / border / shadow). */
export const ADMIN_TABLE_CARD =
  "overflow-hidden !rounded-[15px] border-0 p-0 !shadow-none ring-1 ring-gray-100/80";
...
export const ADMIN_TABLE_THEAD = "border-b border-gray-200 bg-brand-surface/80";
...
export const ADMIN_TABLE_ROW = "hover:bg-brand-surface/60";
...
export const ADMIN_TABLE_TD_CENTER =
  "min-w-0 px-3 py-2.5 text-center align-middle text-sm";
