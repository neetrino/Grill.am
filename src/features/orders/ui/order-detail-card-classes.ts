/** Shared card chrome for the order-details side sheet. */
export const ORDER_DETAIL_CARD =
  "rounded-[20px] bg-white px-5 py-5 shadow-[0_1px_2px_rgba(16,24,40,0.04)]";

/** Section titles for the order-sheet design (brand red). */
