  ...
  return (
    <div className="relative h-[334px] min-h-[200px] overflow-hidden rounded-[24px] bg-[#171717] md:hidden">
      ...
      */}
      ...
      <div className="relative z-10 flex max-w-[62%] flex-col px-5 pt-5">
      ...
      <div className="absolute inset-x-0 bottom-0 z-20 flex items-end justify-between gap-4 px-5 pb-5">
        <AppLink
          href={linkHref}
        ...
        <div className="relative z-20 flex size-20 shrink-0 flex-col items-center justify-center rounded-full bg-brand-red">
          ...
          <span className="text-xl leading-5 font-black text-white">{amount}</span>
          <span className="text-[10px] leading-[15px] font-black text-brand-yellow">
            {currency}
          </span>
        </div>
      </div>
          ...
          <div className="relative h-auto min-h-[420px] overflow-hidden rounded-[30px] bg-[#ffc12c] sm:min-h-[480px] lg:h-[553px] lg:min-h-0">
            ...
            <div className="absolute right-4 bottom-4 z-20 flex items-center gap-6 sm:right-8 sm:bottom-8 lg:right-[72px] lg:bottom-10">
              <div className="flex size-[112px] flex-col items-center justify-center rounded-full bg-[#db0b20]">
                ...
                <span className="text-xs font-black text-[#ffc12c]">
                  {currency}
                </span>
              </div>
